...
本书面向新手程序员，希望小学生们能看懂，也希望编程老手们读了也会感到很有帮助。

这是一套关于计算机与编程开发的课程。

本课程不能代替任何编程课，也不能代替任何一本编程书，它只是你编程之路上的一个催化剂。

本课程是作者多年编程开发经验的一个总结，也有作者多年在写代码、面试、带开发团队、指导计算机编程开发过程中的一些思考。

作者会尝试用最简单的方法和语言，带你理解计算机编程的基本原理、相关概念和编程的本质，希望能帮助你在看其他计算机书的时候事半功倍，在未来的学习和工作中能“以不变应万变”。

本课程的目标读者：所有人。

大到做一个产品，小到写一本书，通常都需要设定自己的目标用户或目标读者。然而本书的目标读者却没有那么明确，如果说明确，那就是——所有人。比如——

- 小学生：现在，很多小学生就已经开始学习编程，他们需要一本“课外书”，这本书会陪伴他们从小学到大学的编程旅程。
- 大学生：作者见过很多大学生，即使是计算机系毕业的学生，很多对编程也是一知半解。是我们的教育错了吗？还是学习不努力？希望能从本书找到答案。
- 刚走上工作岗位的程序员：我得到了一个编程工作的岗位，学什么？从哪里学？怎么学？
- 资深程序员：我都走过哪些弯路？我怎么告诉新手程序员少走弯路？
...
人工智能都能写代码了？未来还需要程序员吗？

不就是改一行代码的事吗？不就是改一个 Logo 吗？

本书特点：

- 简单直观：直击问题本质，轻松理解一个概念、问题及解决方法。
- 博大精深：本书描述了很多数学原理、语言、协议、技术和工具，通过横向对比深入洞悉的本质和这些技术存在的意义。
